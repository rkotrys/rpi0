...
class clock:
    ...
    def drawnetwork(self,draw):
        ...
        draw.rectangle([(128-20,1),(128,20)], fill='#00000011', outline='#00000011', width=1)
        draw.text( (128-16,25), symbol, font=self.symbols, fill=tuple(self.cnf["clock"]["icons_color"]) )
