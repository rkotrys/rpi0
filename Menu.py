    ...
    def show(self):
        if self.active:
            ...
            if len(self.state)>0:
                ...
                dr.text( ((self.size[0]-txtsizep[0])/2, (self.size[1]-txtsize[1])/2-20), self.state[previousitem]['label'], fill=self.fill, font=self.font )
                dr.text( ((self.size[0]-txtsizen[0])/2, (self.size[1]-txtsize[1])/2+20), self.state[nextitem]['label'], fill=self.fill, font=self.font )
